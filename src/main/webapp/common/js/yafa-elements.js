$(document).ready(function(){
	...
	if( $('body').hasClass('flash-alert') ) {
		...
		if ( navigator.userAgent.match("Firefox/") ) {
			flashMsgSound.src = "common/audio/flash-message.ogg"/*tpa=common/js/common/audio/flash-message.ogg*/;
			offlineSound.src = "common/audio/offline.ogg"/*tpa=common/js/common/audio/offline.ogg*/;
		}else {
			flashMsgSound.src = "common/audio/flash-message.mp3"/*tpa=common/js/common/audio/flash-message.mp3*/;
			offlineSound.src = "common/audio/offline.mp3"/*tpa=common/js/common/audio/offline.mp3*/;
		}
		...
		$('#gritter-image').click( function() {
			$.gritter.add({
				title: 'Jane Doe',
				text: 'Online',
				image: 'common/img/user3.png'/*user3.png*/,
				time: 2000,
				after_close: function() {
					$.gritter.add({
						title: 'Jordan Smith',
						text: 'Offline',
						image: 'common/img/user5.png'/*user5.png*/,
						time: 2000
					});
	...
	if( $('.dropzone').length > 0 ) {
		...
		$(".dropzone").dropzone({
			url: "common/js/php/dropzone-upload.php",
			addRemoveLinks : true,
			maxFilesize: 0.5,
			maxFiles: 5,
	...
	if( $('body').hasClass('forms-inplace-editing') ) {
		...
		$('#switch-inline-input').on('change', function() {
			if( $(this).prop('checked') == true) {
				...
				window.location.href="yafa-elements.js-mode=inline";
			}else {
				localStorage.setItem('xmode', 'popup');
				window.location.href="yafa-elements.js-mode=popup";
			}
		});
	}
