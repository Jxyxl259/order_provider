 ...
 * SynPolicy
 */
@Table(name = "t_syn_policy")
public class SynPolicyDto extends BaseDto implements Serializable {

    private static final long serialVersionUID = SynPolicyDto.class.getName().hashCode();
