 ...
 * SynPolicySurrender
 */
@Table(name = "t_syn_policy_surrender")
public class SynPolicySurrenderDto extends BaseDto implements Serializable {

    private static final long serialVersionUID = SynPolicySurrenderDto.class.getName().hashCode();
    ...
    /** 同步保单处理状态 0-未处理,1-处理中,2-处理成功,3-处理失败 */
    private String dealStatus;

    /** 处理次数 */
    private Integer dealCount;

    /** 0:初始状态;1:核保通过;2:核保不通过;3:自动核保;4:拒保;5:复核通过;6:承保确认;7:复核不通过;8:待复核9:待核保 */
    ...
    /**
     * 获取属性同步保单处理状态 0-未处理,1-处理中,2-处理成功,3-处理失败的值
     */
    ...
    /**
     * 设置属性同步保单处理状态 0-未处理,1-处理中,2-处理成功,3-处理失败的值
     */
    ...
    /**
     * 获取属性0:初始状态;1:核保通过;2:核保不通过;3:自动核保;4:拒保;5:复核通过;6:承保确认;7:复核不通过;8:待复核9:待核保的值
     */
    ...
    /**
     * 设置属性0:初始状态;1:核保通过;2:核保不通过;3:自动核保;4:拒保;5:复核通过;6:承保确认;7:复核不通过;8:待复核9:待核保的值
     */
