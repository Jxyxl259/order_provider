...
public class TransQueryActivationCardInfoResp {
    ...
    /** 销售信息 */
    private TransSalesInfoDto salesInfoDto;
	...
	/** 销售信息 */
	public TransSalesInfoDto getSalesInfoDto() {
		return salesInfoDto;
	}

	/** 销售信息 */
	public void setSalesInfoDto(TransSalesInfoDto salesInfoDto) {
