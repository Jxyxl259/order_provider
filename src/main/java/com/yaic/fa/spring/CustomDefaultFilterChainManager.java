...
public class CustomDefaultFilterChainManager extends DefaultFilterChainManager {
    ...
    private void applyLoginUrlIfNecessary(Filter filter) {
        ...
        if (StringUtil.isNotEmpty(loginUrl) && (filter instanceof AccessControlFilter)) {
    ...
    private void applySuccessUrlIfNecessary(Filter filter) {
        ...
        if (StringUtil.isNotEmpty(successUrl) && (filter instanceof AuthenticationFilter)) {
    ...
    private void applyUnauthorizedUrlIfNecessary(Filter filter) {
        ...
        if (StringUtil.isNotEmpty(unauthorizedUrl) && (filter instanceof AuthorizationFilter)) {
